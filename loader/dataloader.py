...
# down-scaling with random factors
...
# random fliping for data augmentation
...
# random shifting for data augmentation
...
# this sampler ensures the same metabolite in a training batch
class Met_Sampler(Sampler):
    ...
    def __len__(self) -> int:
        return math.floor(self.length / 7 / self.batch_size) * 7     # 7 types of metabolites
