...
def save_python_script(args):
    ...
    ## copy model
    shutil.copyfile('models/cleaned9/' + args.model + '.py', str(args.exp_dir) + '/' + args.model + '.py')
    ## copy loader
    shutil.copyfile('loader/dataloader.py', str(args.exp_dir) + '/dataloader.py')
    if args.adv_weight_train != 0.0:
        shutil.copyfile('models/cleaned9/cWGAN.py', str(args.exp_dir) + '/cWGAN.py')
...
def build_model(args):
    ...
    elif args.model == 'MUNet_multiresFS':
...
def create_arg_parser():
    ...
    parser.add_argument('--model', type=str, default='MUNet_multiresHN', choices=['MUNet'], help='model')
    parser.add_argument('--modelD', type=str, default='Discriminator', choices=['Discriminator', 'Discriminator_uf', 'Discriminator_uf_met'], help='model')
    ...
    # select from [1, 2, 4, 6, 8, 9, 12, 14, 15, 16, 17, 18, 19, 20, 22] (exclude 11 to get multiples of 3)
    ...
    parser.add_argument('--exp-dir', type=str, default='checkpoints/cleaned9', help='Path to save models and results')
